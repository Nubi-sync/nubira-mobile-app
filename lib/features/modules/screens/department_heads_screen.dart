...
class _AppointHeadModal extends StatefulWidget {
  ...
  @override
  State<_AppointHeadModal> createState() => _AppointHeadModalState();
}

class _AppointHeadModalState extends State<_AppointHeadModal> {
  ...
  void _onNameChanged(String val) {
    if (widget.existingHead == null) {
      ...
      if (clean.isNotEmpty) {
        final suffix = _selectedModules.isNotEmpty ? _selectedModules[0].replaceAll('/', '') : 'head';
  ...
  Future<void> _handleSave() async {
    ...
    if (name.isEmpty || username.isEmpty) {
      setState(() => _error = 'Please enter Head Full Name and Login Username');
      return;
    }

    if (widget.existingHead == null && password.length < 6) {
      setState(() => _error = 'Initial Password must be at least 6 characters');
      return;
    }

    if (_selectedModules.isEmpty) {
      setState(() => _error = 'Please assign at least 1 manufacturing unit to this Head');
      return;
    }
    ...
    try {
      ...
      setState(() {
        _isSaving = false;
        _error = 'Error saving Department Head: $e';
      });
    }
  }
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.person_add_outlined, color: AppTheme.brandSteel, size: 20),
                  ),
                  const SizedBox(width: 12),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      Text(
                        widget.companyName,
                        style: GoogleFonts.publicSans(fontSize: 11, color: AppTheme.mutedInk, fontWeight: FontWeight.bold),
                      ),
                    ],
                  ),
                ],
              ...
              IconButton(
                icon: const Icon(Icons.close_rounded, color: AppTheme.mutedInk),
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    style: GoogleFonts.publicSans(fontSize: 13.5, fontWeight: FontWeight.w600, color: AppTheme.foregroundInk),
                  ...
                  TextField(
                    ...
                    style: GoogleFonts.jetBrainsMono(fontSize: 13, fontWeight: FontWeight.w700, color: AppTheme.foregroundInk),
                    decoration: const InputDecoration(
                  ...
                  TextField(
                    ...
                    style: GoogleFonts.jetBrainsMono(fontSize: 13, fontWeight: FontWeight.w600, color: AppTheme.foregroundInk),
                    decoration: const InputDecoration(
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        isEditing ? 'UPDATE PASSWORD (OPTIONAL)' : 'INITIAL PASSWORD *',
                        style: GoogleFonts.jetBrainsMono(fontSize: 10.5, fontWeight: FontWeight.w800, color: AppTheme.mutedInk),
                      ),
                      InkWell(
                        ...
                        child: Text(
                          'Auto-Generate',
                          style: GoogleFonts.publicSans(fontSize: 11, fontWeight: FontWeight.bold, color: AppTheme.brandSteel),
                        ),
                      ),
                    ],
                  ),
